...
<html lang="es">
    <head>
        <meta charset="utf-8">
        <title>Confirmar   - TEMPLATE</title>
                                    ...
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            ...
                                            <div class="p-2 mt-4">
                                                ...
                                                <p class="text-muted">Su cuenta a sido validada, ya puede regresar a la pantalla principal y acceder al sistema de TEMPLATE.</p>
                                                <div class="mt-4">
