...
if (isset($_SESSION["usu_id"]) && count($datos) > 0) {
    ...
    <body>
        ...
        <div id="layout-wrapper">
                        ...
                        <div class="row">
                            <div class="col-12">
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 class="mb-sm-0 font-size-18">Lista de Procesos</h4>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <p class="card-title-desc">(*) Vista para Registrar, Modificar, Listar y
                                                    Eliminar. </p>
                                            </div>
            ...
            <script type="text/javascript" src="mntproceso.js"></script>
